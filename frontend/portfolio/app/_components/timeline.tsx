  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white max-w-4xl bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
          Professional Journey
        </h2>
        <p className="text-gray-300 text-sm md:text-base max-w-sm">
          My experience and growth in software development and AI/ML engineering.
        </p>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black flex items-center justify-center border border-gray-600">
                <div className="h-4 w-4 rounded-full bg-gray-400 border border-gray-500 p-2" />
              </div>
